...
MINI-NODE-FAAS是一款开源的、基于NodeJs的FaaS解决方案，它可以让我们使用Serverless的方式编写JS代码。
MINI-NODE-FAAS使用浏览器指纹标注用户信息，因此无需登录。
...
## 注意事项
（1）由于服务器性能有限，以及nodejs本身的短板，MINI-NODE-FAAS在计算密集型的任务上表现很差。
